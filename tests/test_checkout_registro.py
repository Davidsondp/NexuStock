...
def test_registro_muestra_plan_comercial_seleccionado(
    ...
    respuesta = client.get("/autenticacion/registro" "?plan=profesional-pago" "&ciclo=anual")

    assert respuesta.status_code == 200
    assert b"data-plan-seleccionado=" b'"profesional-pago"' in respuesta.data
...
def test_registro_crea_solicitud_comercial_atomica(
    ...
    seleccion = client.get("/autenticacion/registro" "?plan=profesional-pago" "&ciclo=anual")
...
def test_seleccion_sobrevive_error_de_validacion(
    ...
    client.get("/autenticacion/registro" "?plan=profesional-pago" "&ciclo=mensual")
