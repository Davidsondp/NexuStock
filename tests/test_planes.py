...
def test_catalogo_declara_estado_y_condiciones():
    ...
    assert (
        catalogo["lotes_vencimientos"]["condicion"]
        == "segun_rubro"
    )
    assert catalogo["ia"]["estado"] == "proximamente"
