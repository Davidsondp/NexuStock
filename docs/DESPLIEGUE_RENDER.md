...
- En los cron `nexustock-alertas` y `nexustock-snapshots` configura los mismos valores de `SECRET_KEY`,
  `WEBHOOK_PAGOS_SECRET`, `LIMITE_SOLICITUDES_SECRET`, `TRUSTED_HOSTS`, `MAIL_SERVER`
