...
def listar_sucursales():
    ...
    sucursales = ServicioUbicaciones(
        current_user
    ).listar_sucursales(
...
@ubicaciones_bp.patch(
    "/sucursales/<int:sucursal_id>"
)
@login_required
...
@ubicaciones_bp.post(
    "/sucursales/<int:sucursal_id>/reactivar"
)
@login_required
@requerir_permiso("sucursales.editar")
...
@ubicaciones_bp.post(
    "/bodegas/<int:bodega_id>/reactivar"
)
@login_required
@requerir_permiso("bodegas.editar")
